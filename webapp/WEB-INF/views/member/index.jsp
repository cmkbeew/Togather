...
<html lang="en">
  <head>
	...
	<script src="http://code.jquery.com/jquery-latest.js"></script>
      ...
      <script type="text/javascript">
      function showPageGroups(start,end){
    	  var page=start;
    	  var pageSize=end;
    		$.ajax({
    			url:"page",
    				...
    				if(!jQuery.isEmptyObject(result)){
    					...
    					$("#pageDiv").empty();
	    					...
	    					$("#pageDiv").append(
	    						...
	    						+"<c:if test='${pm.prev}'>"
	    						+"<li class='page-item'>"
	    						+"<a class='page-link' href='javascript:showPageGroups(${pm.startPage-1},${cri.pageSize})'>처음</a>"
	    						+"</li>"
	    						+"</c:if>"
	    						+"<c:if test='${pm.prev}'>"
	    						+"<li class='page-item'>"
	    						+"<a class='page-link' href='javascript:showPageGroups(${cri.page-1},${cri.pageSize})'>이전</a>"
	    						+"</li>"
	    						+"</c:if>"
	    						+"<c:forEach var='idx' begin='${pm.startPage }' end='${pm.endPage }'>"
	    						+"<li class='page-item'>"
	    						+"<a id='pageId' class='page-link' href='javascript:showPageGroups(${idx},${cri.pageSize})'>${idx}</a>"
	    						+"</li>"
	    						+"</c:forEach>"
	    						+"<c:if test='${pm.next && pm.endPage > 0}'>"
	    						+"<li class='page-item'>"
	    						+"<a class='page-link' href='javascript:showPageGroups(${cri.page+1},${cri.pageSize})'>다음</a>"
	    						+"</li>"
	    						+"</c:if>"
	    						+"<c:if test='${pm.next && pm.endPage > 0}'>"
	    						+"<li class='page-item'>"
	    						+"<a class='page-link' href='javascript:showPageGroups(${pm.endPage},${cri.pageSize})'>끝</a>"
	    						+"</li>"
	    						+"</c:if>"
	    						+"</ul>"
	    						+"</nav>"
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          ...
          <c:if test="${m ne null}">
          	<li><a href="websocket">나의 모임</a></li>
      ...
      <section id="popular-courses" class="courses">
        ...
        <div id="pageDiv">
            <nav aria-label="Page navigation example">
                  ...
                  <c:if test="${pm.prev}">
                    <li class="page-item">
                      <a class="page-link" href="javascript:showPageGroups(${pm.startPage-1},${cri.pageSize})">처음</a><!-- "/?page=${pm.startPage-1}&pageSize=${cri.pageSize}" -->
                    </li>							
                  </c:if>
                  <c:if test="${pm.prev}">
                    <li class="page-item">
                      <a class="page-link" href="javascript:showPageGroups(${cri.page-1},${cri.pageSize})">이전</a><!-- "/?page=${cri.page-1}&pageSize=${cri.pageSize}" -->
                    </li>
                  </c:if>
                  <c:forEach var="idx" begin="${pm.startPage }" end="${pm.endPage }">
                    <li class="page-item">
                      <a id="pageId" class="page-link"  href="javascript:showPageGroups(${idx},${cri.pageSize})">${idx}</a><!--  /?page=${idx}&pageSize=${cri.pageSize} -->
                    </li> 
                  </c:forEach>
                  <c:if test="${pm.next && pm.endPage > 0}">
                    <li class="page-item">
                      <a class="page-link" href="javascript:showPageGroups(${cri.page+1},${cri.pageSize})">다음</a><!-- "/?page=${cri.page+1}&pageSize=${cri.pageSize}" -->
                    </li>
                  </c:if>
                  <c:if test="${pm.next && pm.endPage > 0}">
                    <li class="page-item">
                      <a class="page-link" href="javascript:showPageGroups(${pm.endPage},${cri.pageSize})">끝</a><!-- "/?page=${pm.endPage}&pageSize=${cri.pageSize}" -->
                    </li>
                  </c:if>
                  </ul>
                </nav>
